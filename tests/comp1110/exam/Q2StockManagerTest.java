...
public class Q2StockManagerTest {
    ...
    private void setupItem(Q2StockManager sm, String sku, String vid, String name, double price, int targetStock, int stock, int sale) {
    ...
    private void setupStore(Q2StockManager sm) {
        sm.newVendor("A035", "ACME Corp");
